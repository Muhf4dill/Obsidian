...
1. Karena kita ingin mengkostumisasi warna background kita menjadi hijau maka kita akan memakai bg-succes . ketikkan bg-succes pada class tag pembuka seperti di bawah ini
...
![btc-100.png](Asetb/btc-100.png)

8. Maka hasilnya akan seperti ini:
	![gambar](Asetb/btc-68.png)
	*Keterangan:*
